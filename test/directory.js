...
describe('directory()', function(){
  describe('when given Accept: header', function () {
    ...
    describe('of application/json; q=0.5, text/html; q=0.8, */*; q=0.01', function () {
      it('should negotiate to html', function (done) {
        app.request()
        .get('/')
        .set('Accept', 'application/json; q=0.5, text/html; q=0.8, */*; q=0.01')
        .end(function(res){
          utils.mime(res).should.equal('text/html');
          done();
        });
