...
module.exports = {
    ...
    'test parseCookie()': function(){
      ...
      utils.parseCookie('foo   = bar;  baz    =  raz').should.eql({ foo: 'bar', baz: 'raz' });  
      utils.parseCookie('fbs="uid=0987654321&name=Test+User"').should.eql({ fbs: 'uid=0987654321&name=Test User' });
    },
