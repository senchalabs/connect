...
module.exports = function compress(options) {
  options = options || {};
  var names = Object.keys(exports.methods).concat('identity')
  ...
  return function compress(req, res, next){
    ...
    res.on('header', function(){
      ...
      var negotiator = req.negotiator = req.negotiator || new Negotiator(req);
      method = negotiator.preferredEncodings(names)[0];
