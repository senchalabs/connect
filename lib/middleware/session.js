...
/**
 * Default session hashing function
 */
function defaultHash(req, base) {
...
function session(options){
  ...
  store.hash = options.hash;

  // sessionID generating function
  store.genSID = options.genSID || function (req) {
    ...
    res.writeHead = function(status, headers){
      if (req.session) {
        ...
        if (secured || !cookie.secure) {
          ...
          res.setHeader('Set-Cookie', key, req.sessionID);
        }
      }
