...
/*
 *  Variable to store first generated value of
 *  csrf secret via non blocking callback
*/
var initalCsrfSecret;
/**
 * Anti CSRF:
 *
...
module.exports = function csrf(options) {
  ...
  return function(req, res, next){
    ...
    uid(24, function(err, secret){
      ...
      // making sure that csrf secret is not generated multiple times as
      // this is a non blocking callback, if another requested has already generated
      // a secret it should be used
      req.session._csrfSecret = initalCsrfSecret || (initalCsrfSecret = secret);
      createToken(initalCsrfSecret);
    });
