...
var utils = require('../utils')
  ...
  , defaultJsonRegExp = /^application\/([\w!#\$%&\*`\-\.\^~]*\+)?json$/i;
...
exports = module.exports = function(options){
  var options = options || {}
    ...
    , jsonRegExp = options.jsonRegExp || defaultJsonRegExp;
  ...
  return function json(req, res, next) {
    ...
    // check Content-Type
    if (!jsonRegExp.test(utils.mime(req))) return next();
...
exports.defaultJsonRegExp = defaultJsonRegExp;
