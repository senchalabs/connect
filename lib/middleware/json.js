...
exports = module.exports = function(options){
  ...
  return function json(req, res, next) {
    ...
    // check Content-Type
    //
    // Case insensitive match of mime types with the form
    //    application/json
    // or, with suffix notation
    //    application/vnd.your.possibly-dashed-name.here+json
    if (!/application\/([\w\.\-]*\+)?json/i.test(utils.mime(req))) return next();
