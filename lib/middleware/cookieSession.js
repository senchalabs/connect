...
module.exports = function cookieSession(options){
  ...
  return function cookieSession(req, res, next) {
    ...
    function getSession() {
      req._session = {};
      var cookie = req._session.cookie = new Cookie(options.cookie);
      ...
      if (!options.secret && req.secret) {
        req._session = req.signedCookies[key] || {};
        req._session.cookie = cookie;
      } else {
        // TODO: refactor
        ...
        if (rawCookie) {
          ...
          if (unsigned) {
            ...
            req._session = utils.parseJSONCookie(unsigned) || {};
            req._session.cookie = cookie;
          }
        }
      }
      ...
      // check security
        ...
        // serialize
        debug('serializing %j', req._session);
        var val = 'j:' + JSON.stringify(req._session);
