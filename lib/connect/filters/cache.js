...
module.exports = {
    ...
    setup: function (env, options) {
        options = options || {};
        // Default to 30 second ram cache.
        ramCache = options.ramCache || 30000;
    },
    ...
    handle: function (req, res, next, scope) {
        ...
        var key = req.headers["accept-encoding"] + req.url.pathname,
