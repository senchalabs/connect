 ...
 *     connect.createSecureServer(
          httpsOptions,
 *        connect.log(),
 *        connect.staticProvider(__dirname + '/public')
 *     );
 *
 *     var server = connect.createSecureServer(httpsOptions);
 *     server.use('/', connect.log());
 *     server.use('/', connect.static(__dirname + '/public'));
 *
 * @param {Object} httpsOptions - object with key and cert properties
 * @params {Function} ...
 * @return {Server}
 * @api public
 */
 
var SecureServer = exports.SecureServer = function SecureServer(httpsOptions, layers) {
  this.stack = [];
  ...
  // Set up the request handler using the parent's constructor
  https.Server.call(this, httpsOptions, this.handle);
};
...
var handle = function(req, res, outerNext) {
...
/**
 * Shortcut for `new connect.SecureServer([ ... ])`.
 *
 * @param  {Object} httpsOptions object with key and cert properties
 * @param  {Function} ...
 * @param  {Object} env
...
exports.createSecureServer = function() {
  var args = Array.prototype.slice.call(arguments);
  var httpsOptions = args.shift();
  return new SecureServer(httpsOptions, Array.prototype.slice.call(args));
};
